...
public class Intro
{
    ...
    private TypingLabel setUpContentLabel(IntroState state)
    {
        ...
        {
            label = new TypingLabel("{SPEED=0.8}The world was invaded by {COLOR=PINK}aliens{CLEARCOLOR}.\n " +
            ...
            label.setWrap(true);
            Assets.instance.sounds.typing.play();
            label.setTypingListener(new TypingListener()
            {
                ...
                public void end()
                {
                    Assets.instance.sounds.typing.pause();
        ...
        {
            label = new TypingLabel("{SPEED=0.8}Use {COLOR=BLUE}left{CLEARCOLOR} and {COLOR=BLUE}right{CLEARCOLOR} arrow to {WAVE}move{ENDWAVE} + {COLOR=BLUE}spacebar{CLEARCOLOR} to {JUMP}{COLOR=BLACK}shoot coal{CLEARCOLOR}{ENDJUMP}.\n " +
            ...
            label.setTypingListener(new TypingListener()
            {
                ...
                public void end()
                {
                    Assets.instance.sounds.typing.stop();
                    Intro.this.state = Intro.this.state.getNextState();
                    initUI(Intro.this.state);
                }
                @Override
